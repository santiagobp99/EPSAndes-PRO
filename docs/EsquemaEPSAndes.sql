...
ALTER TABLE "SERVICIO_SALUD" 
 ADD CONSTRAINT "CK_SERVICIO_SALUD_TIPO" CHECK (TIPO IN( 'INTERVENCION', 'DIALISIS', 'CIRUGIA_AMBULATORIA', 'CIRUGIA', 'FISIOTERAPIA', 'TERAPIA_OCUPACIONAL', 'IMAGEN_DIAGNOSTICA', 'HOSPITALIZACION', 'EXAMEN_DIAGNOSTICO', 'CITA_MEDICA', 'CONSULTA_ESPECIALISTA'))
;
