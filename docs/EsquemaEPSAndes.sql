...
;
ALTER TABLE "AFILIADO"
	ADD CONSTRAINT "CK_DOCUMENTO" CHECK ( TIPODOCUMENTO IN('CC','CE','PA','RC','TI') )
;
ALTER TABLE "AFILIADO"
	ADD CONSTRAINT "CK_HOSPITALIZADO" CHECK ( CK_HOSPITALIZADO IN(0,1) )
;
...
;
ALTER TABLE "CITA_MEDICA"
	ADD CONSTRAINT "CK_DISPONIBILIDAD" CHECK ( TIPO IN( 'INICIAL', 'CONTROL') )
;
ALTER TABLE "CITAS_DE_SERVICIOS" 
...
;
ALTER TABLE "IPS"
	ADD CONSTRAINT "CK_TIPO" CHECK ( TIPO IN( 'HOSPITAL', 'CENTRO_DE_ATENCION', 
	'CENTRO_MEDICO', 'LABORATORIO'))
;
ALTER TABLE "IPS"
	ADD CONSTRAINT "CK_CAPACIDAD" CHECK ( CAPACIDAD >=0)
;
...
;
ALTER TABLE "MEDICO"
	ADD CONSTRAINT "CK_CAPACIDAD" CHECK ( NUMREGISTROMEDICO >=0)
;
ALTER TABLE "MEDICO_ESPECIALISTA" 
...
;
ALTER TABLE "SERVICIO_SALUD"
	ADD CONSTRAINT "CK_DISPONIBILIDAD" CHECK ( DISPONIBILIDAD IN(0,1) )
;
ALTER TABLE "SERVICIO_SALUD"
	ADD CONSTRAINT "CK_TIPO" CHECK ( TIPO IN( 'INTERVENCION', 'DIALISIS', 
	'CIRUGIA_AMBULATORIA', 'CIRUGIA', 'FISIOTERAPIA', 'TERAPIA_OCUPACIONAL', 'IMAGEN_DIAGNOSTICA', 
	'HOSPITALIZACION', 'EXAMEN_DIAGNOSTICO', 'CITA_MEDICA', 'CONSULTA_ESPECIALISTA') )
;
ALTER TABLE "SERVICIO_SALUD"
	ADD CONSTRAINT "CK_ESTADO" CHECK ( ESTADO IN( 'RESERVADO', 'ASISTENCIA', 'CANCELADO') )
;
ALTER TABLE "USUARIO" 
