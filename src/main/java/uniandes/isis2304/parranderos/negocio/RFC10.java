...
public class RFC10 {
	...
	public RFC10(String nombre, String correo, Timestamp fechaNacimiento, String tipoDocumento, String numDocumento,
	...
	public String toString() {
		return "RFC10 [nombre=" + nombre + ", correo=" + correo + ", fechaNacimiento=" + fechaNacimiento
