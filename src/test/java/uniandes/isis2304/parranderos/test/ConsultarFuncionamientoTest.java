 ...
 *
 */
public class ConsultarFuncionamientoTest
{
	/* ****************************************************************
	 * 			Constantes
	 *****************************************************************/
	 ...
	 */
	private static Logger log = Logger.getLogger(ConsultarFuncionamientoTest.class.getName());
...
//			e.printStackTrace();
    	...
    	try
		{
			...
			List <RFC11A> listaA = parranderos.RFC11AConsultarFuncionamiento();
			List <RFC11B> listaB = parranderos.RFC11BConsultarFuncionamiento();
			List <RFC11C> listaC = parranderos.RFC11CConsultarFuncionamiento();
